...
/**
 * This class allows following a nl.oopgame.supaplex.GameObject in the Viewport.
 * The Viewport will move if the followed nl.oopgame.supaplex.GameObject if the maximum tolerance in a certain direction from its center is reached.
 */
