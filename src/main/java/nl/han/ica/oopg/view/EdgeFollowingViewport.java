...
/**
 * This class allows following an nl.oopgame.supaplex.GameObject in the Viewport.
 * The viewport will move if the followed nl.oopgame.supaplex.GameObject reaches the side of the viewport minus the given tolerance.
 */
