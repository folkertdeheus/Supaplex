...
public abstract class GameObject implements IKeyInput, IMouseInput, PConstants {
    ...
    /**
     * Implement this method to actually draw the nl.oopgame.supaplex.GameObject.
     *
    ...
    /**
     * Gets the x position of the nl.oopgame.supaplex.GameObject.
     *
     * @return x
     */
    public float getX() {
    ...
    /**
     * Sets the x position of the nl.oopgame.supaplex.GameObject.
     *
    ...
    /**
     * Gets the y position of the nl.oopgame.supaplex.GameObject.
     *
     * @return y
     */
    public float getY() {
    ...
    /**
     * Sets the y position of the nl.oopgame.supaplex.GameObject.
     *
    ...
    /**
     * Gets the width of the nl.oopgame.supaplex.GameObject.
     *
     * @return width
     */
    ...
    /**
     * Sets the width of the nl.oopgame.supaplex.GameObject.
     *
    ...
    /**
     * Gets the height of the nl.oopgame.supaplex.GameObject.
     *
     * @return height
     */
    ...
    /**
     * Sets the height of the nl.oopgame.supaplex.GameObject.
     *
    ...
    /**
     * Gets the z position of the nl.oopgame.supaplex.GameObject.
     *
     * @return z
     */
    public float getZ() {
    ...
    /**
     * Sets the z position of the nl.oopgame.supaplex.GameObject.
     *
    ...
    /**
     * Returns whether the nl.oopgame.supaplex.GameObject is visible or not.
     *
     * @return isVisible
     */
    ...
    /**
     * Used to set or unset the visibility of the nl.oopgame.supaplex.GameObject.
     *
    ...
    /**
     * Gets the center x position of the nl.oopgame.supaplex.GameObject.
     *
     * @return centerX
     */
    ...
    /**
     * Gets the center y position of the nl.oopgame.supaplex.GameObject.
     *
     * @return centerY
     */
     ...
     *
     * @param object nl.oopgame.supaplex.GameObject of which you would like to know whether its position lays from your left or from your right.
