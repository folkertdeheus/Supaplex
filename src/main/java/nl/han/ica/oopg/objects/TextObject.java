...
/**
 * Use this class to draw text. You could also implement it by your own by overriding the nl.oopgame.supaplex.GameObject class and use Processing to draw text.
 */
